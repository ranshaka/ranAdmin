<template>
    <div class="content2 minHeight100">
        ...
        <a-row gutter="20" class="titleList">
            <a-col :span="6">
                <a-card class="box-card width100 tatleBox">
                    <template #header>
                    ...
                    <a-alert title="success alert" type="success" />
                    <a-alert title="info alert" type="info" />
                    <a-alert title="warning alert" type="warning" />
                </a-card>
            </a-col>
          
            <a-col :span="6">
                <a-card class="box-card width100 tatleBox" :body-style="{ padding: '0px' }">
                    <template #header>
                        <div class="card-header">
                            <span>下载曲线</span>
                            <div class="zhuhui cyan">212313132</div>
            ...
            <a-col :span="6">
                <a-card class="box-card width100 tatleBox">
                    ...
                    <div>
                        <a-progress :percentage="50" class="margin-top-sl" />
                        <a-progress :percentage="100" :format="format" class="margin-top-2x" />
                        <a-progress :percentage="100" status="success" class="margin-top-2x" />
                        <a-progress :percentage="100" status="warning" class="margin-top-2x" />
                        <a-progress :percentage="50" status="exception" class="margin-top-2x" />
                    </div>
                </a-card>
            </a-col>
        </a-row>
