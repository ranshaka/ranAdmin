<template>
    <div class="content minHeight100">
        ...
        <div>
            <el-button type="danger" @click.prevent="clearPanel">清空签名</el-button>
            <el-button type="success" @click="confirm">确认签名</el-button>
        </div>
        <el-divider />
        <template>
            <el-switch v-model="theme" inline-prompt :active-icon="MySun" :inactive-icon="MyMoon"
                style="--el-switch-on-color: #f2f2f2; --el-switch-off-color: #2c2c2c" @change="toggleDark()" />
        </template>
        <el-row>
            <el-col :span="12">
