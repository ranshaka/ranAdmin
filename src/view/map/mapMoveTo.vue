...
<template>
    <div class="homeInfo">
        ...
        <div class="homeInfoCar">
            <div >
                <div style="display:flex;align-items: center;">
                    <el-button type="warning" @click="startAnimation">重新播放</el-button>
                    ...
                    <div style="display:flex">
                        <el-tag size="Default" @click="linebackspeedMIN">减速行驶</el-tag>
                        <el-tag size="Default" @click="pauseAnimation">暂停行驶</el-tag>
                        <el-tag size="Default" @click="resumeAnimation">继续行驶</el-tag>
                        <el-tag size="Default" @click="linebackspeedMAX">加速行驶</el-tag>
            ...
            <el-table :data="tableData[tableDataIndex]" border style="width: 100%" 
        ...
        <div class="flex space-between ">
            <div></div>
            <el-pagination  background layout="prev, pager, next"   :page-size="tableDataSize"    @current-change="currentChange"  :current-page="tableDataIndex" :total="tableDataTotal" />
        </div>
