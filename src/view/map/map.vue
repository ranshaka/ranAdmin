...
<script>
    ...
    import mapleft from "@/view/map/homeInfoExt/mapleft.vue"
    import mapright from "@/view/map/homeInfoExt/mapright.vue"
    import mapbottom from "@/view/map/homeInfoExt/mapbottom.vue"
    // import model from "@/view/map/model/model.vue"
...
<style lang="less">
    .mapInfo {
        position: relative;
        height: calc( 100vh - 80px - 64px - 12px);
        // width: 100%;
        // height: 100%;
...
.modelTitle{
    background: url("./images/view/1j.png");
    ...
    font-weight: 600;
    word-spacing:20px;
    text-shadow: 2px 2px 20px #2C53AE;
    position: relative;
    margin-bottom:6px;
}
