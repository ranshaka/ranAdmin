...
<template>
    <div class="colorPicker"  >
        <div class="colorBox" @click="viewFlag=true">
          <!-- @blur="viewFlag=false" -->
            <input type="button"  @blur="viewFlag=false" class="colorView"  :style="'background:'+modelValue"  >
        </div>
            <div class="color-select" v-if="viewFlag"  @mousedown.stop.prevent>
