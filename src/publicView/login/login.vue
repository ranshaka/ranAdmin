            ...
            <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="80px" class="demo-ruleForm"
                ...
                <el-form-item>
                    <el-button type="primary" style="width:100%;"
                        :disabled="!ruleForm.account || !ruleForm.password || !ruleForm.verifyCode || ruleForm.verifyCode.length!=4"
                        @click="startAnimation">登录</el-button>
                </el-form-item>
                <el-form-item>
                    <div>
                        <identifyCodeView v-model:identifyCode="code"></identifyCodeView>
                    </div>
                </el-form-item>
            </el-form>
        </div>
