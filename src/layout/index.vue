            ...
            <el-container>
                ...
                <el-main>
                    ...
                    <div class="homeMainBox">
                        <div class="homeMain scrollBox " :class="router.currentRoute.value.meta.menu?'':'padding-2x'" v-loading="loading" :style="maxHeidht"
                            ...
                            <template v-if="isRouterAlive">
                                    <transition name="el-fade-in-linear">
                                        <transition :name="transitionNames">
                                            <!-- <keep-alive> -->
                                                <router-view class="" v-waterMarker="{text:'ranAdmin',textColor:'rgba(180, 180, 180, 0.4)',styles:{
                rotate:-20,width:250,height:100}, }"></router-view>
                                            <!-- </keep-alive> -->
                                        </transition>
                                    </transition>
                            </template>
